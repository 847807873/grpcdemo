...
var fileDescriptor_c161fcfdc0c3ff1e = []byte{
	...
	0x99, 0xc0, 0x7a, 0xe1, 0x7c, 0x23, 0x5f, 0x2e, 0xb6, 0xf0, 0xc4, 0xcc, 0x92, 0xd4, 0x22, 0x21,
	0x79, 0x2e, 0x56, 0x97, 0x7c, 0x5f, 0x17, 0x53, 0x21, 0x4e, 0x3d, 0xb0, 0x6b, 0x83, 0x52, 0x0b,
	0xa5, 0xe0, 0xcc, 0x62, 0x25, 0x06, 0x21, 0x25, 0x2e, 0x8e, 0xe0, 0xc4, 0x4a, 0x8f, 0xd4, 0x9c,
	0x9c, 0x7c, 0x5c, 0x6a, 0x92, 0xd8, 0xc0, 0x7e, 0x34, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x5d,
	0x7f, 0xb7, 0x5b, 0xf1, 0x00, 0x00, 0x00,
}
...
func (c *waiterClient) SayHello(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, "/test.Waiter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedWaiterServer) SayHello(ctx context.Context, req *Req) (*Res, error) {
...
func _Waiter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/test.Waiter/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WaiterServer).SayHello(ctx, req.(*Req))
	}
	return interceptor(ctx, in, info, handler)
}
